...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      <h2 class="mb-2 text-xl font-semibold leading-none text-gray-900 md:text-2xl dark:text-white"><?= esc($shoe['name'])?></h2>
      <p class="mb-4 text-xl font-extrabold leading-none text-gray-900 md:text-2xl dark:text-white">$<?= esc($shoe['price'])?></p>
      <dl>
          <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Details</dt>
          <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400"><?= esc($shoe['description'])?></dd>
      </dl>
      <dl class="flex items-center space-x-6">
          <div>
              <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Rating</dt>
              <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400"><?= esc($shoe['rating_rate'])?>/<?= esc($shoe['rating_count'])?></dd>
          </div>
          <div>
              <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Item quantity</dt>
              <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400"><?= esc($shoe['quantity'])?></dd>
          </div>
      </dl>
